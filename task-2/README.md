...
The output of running `make test` should be:
...
I will run your containers, but I will also examine any scripts and configuration files which your solution
requires.

I will not strictly require exactly the text above.  If the text is embedded in an image (asciiart?), then that's fine --
